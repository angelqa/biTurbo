...
biTurbo.proto.initStyle = function (){
	...
	this.createTween("_default_instant",0.02,5); 
};
...
biTurbo.proto.tweenClass = function (element , tempClassName , tween , delay){
	var temp_name;
	var temp_tween = "tween_"+tween;
	var context = this;

	delay = this.defaultParameter(delay,biTurboProps.minDelay);
	element = this.getDomElement(element);	
