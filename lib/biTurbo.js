//////////// VARIABLES ////////////
var a_debug=false,a_loop,a_height,a_width,a_clicked=false,a_insertionPoint; // should be defined on the main banner
var a_currentFrameIndex=0;
var a_timeLine=[];
var a_imagesToLoad=[]
var a_elementsCreated=[]
var a_limitToWaitPreload=15;
...
function a_createClass(name,style){
	...
	a_print("-- \n a_createClass "+tempArguments.class+" : received_values: " + tempArguments.CSS)
...
function a_createDivElement(name , fileNameString , style){
	a_defaultParameter(name,"");
	a_defaultParameter(fileNameString,"");
...
function a_createBorder(color,borderWidth){
	...
	a_createDivElement("border_frame","",("opacity:1 ; left:0px ; top:0px ; background-color:transparent ; width:" + tempWidth + "px ; height:" + tempHeight + "px"))
...
function a_setBTN(element,userClickTagFunctionName,endFrame){
	...
	a_defaultParameter(endFrame,a_timeLine[temp_estimated_endFrame]);
